...
## Google Side
1. 创建 Google Cloud 项目：访问 [Google Cloud Console](https://console.cloud.google.com/) 创建一个新项目。

2. 配置 OAuth 同意屏幕：在 "API 和服务" -> "OAuth 同意屏幕" 中，选择 "外部"，填写必要信息。

3. 创建凭据：在 "[凭据](https://console.cloud.google.com/apis/credentials)" 页面，点击 "创建凭据" -> "OAuth 客户端 ID"。
