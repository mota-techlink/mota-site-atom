  ...
  return (
    <section id="s-billing" className={PAGE}>
      <div className={PAGE_INNER}>
        ...
        {/* Billing models */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.modelsTitle}</h3>
        ...
        {/* Admin adjustments */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.adjustTitle}</h3>
        ...
        {/* Crypto chains */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.cryptoTitle}</h3>
        <div className="flex flex-wrap gap-2">
          {d.cryptoChains.map((ch: any, i: number) => (
            <div key={i} className="px-3 py-2 rounded-lg bg-white/5 border border-white/8 text-center">
              <div className="text-xs font-bold text-white">{ch.chain}</div>
              <div className="text-xs text-white/30">{ch.token}</div>
              <div className="text-xs text-white/20">{ch.note}</div>
            </div>
          ))}
        </div>
      </div>
