  ...
  return (
    <section id="s-scanners" className={PAGE}>
      <div className={PAGE_INNER}>
        ...
        {/* Scanner matrix */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.scannersTitle}</h3>
            ...
            <tbody>
              {d.scanners.map((s: any, i: number) => (
                <tr key={i} className="border-b border-white/5 hover:bg-white/3 transition-colors">
                  ...
                  <td className="px-4 py-2 text-white/30 text-xs">{s.rateLimit}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {/* Skills */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.skillsTitle}</h3>
        ...
        {/* Filter keywords */}
        <h3 className="text-base font-semibold text-white/60 mb-3">{d.filterTitle}</h3>
