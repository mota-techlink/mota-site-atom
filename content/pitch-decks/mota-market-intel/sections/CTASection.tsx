  ...
  return (
    <section id="s-cta" className={`${SECTION} bg-black relative`}>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl text-white/50 mb-12 leading-relaxed">{cta.subtitle}</p>
        ...
        <p className="text-white/30 text-sm">{cta.footnote}</p>
      </div>

      {/* Footer — pinned to bottom of the slide */}
      <div className="absolute bottom-0 inset-x-0 border-t border-white/10 py-5 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/25 text-sm">{footer.copyright}</p>
