  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        {/* Badge */}
        <div className="mi-child inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 text-sm font-medium mb-8">
          <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse" />
          {h.badge}
        </div>

        {/* Title */}
        <h1 className="mi-child text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
          {h.title}
        </h1>

        {/* Title highlight */}
        <p className="mi-child text-3xl sm:text-4xl lg:text-5xl font-bold mb-8">
        ...
        {/* Subtitle */}
        <p className="mi-child text-lg sm:text-xl text-white/60 max-w-3xl mx-auto leading-relaxed mb-12">
          {h.subtitle}
        </p>

        {/* CTAs */}
        <div className="mi-child flex flex-col sm:flex-row gap-4 justify-center mb-20">
          <button
        ...
        {/* Stats */}
        <div className="mi-child grid grid-cols-3 gap-8 max-w-lg mx-auto">
          {h.stats.map((stat, i) => (
