  ...
  return (
    <section id="s-cta" className={`${SECTION} bg-d-bg relative`}>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="mi-child text-stone-300/70 text-sm sm:text-base max-w-xl mx-auto mb-8 leading-relaxed">{ct.subtitle}</p>
        <div className="mi-child flex flex-col sm:flex-row gap-3 justify-center mb-6">
          <button className="px-8 py-3 rounded-full bg-gradient-to-r from-amber-500 to-orange-400 text-white font-semibold text-sm sm:text-base hover:opacity-90 transition-opacity">
            {ct.primary}
          </button>
          <button className="px-8 py-3 rounded-full bg-white/5 border border-amber-600/40 text-white font-semibold text-sm sm:text-base hover:bg-white/10 transition-colors">
            {ct.secondary}
          </button>
        </div>
