...
export function ValueSection() {
  ...
  return (
    <section id="s-value" className={`${SECTION} bg-d-bg relative`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {v.items.map((item: any, i: number) => (
            <div
              ...
              className={`mi-child rounded-xl bg-d-bg/60 border border-indigo-400/25 p-5 sm:p-6 ${isMobile ? "cursor-pointer active:scale-[0.98] transition-transform" : ""}`}
            >
