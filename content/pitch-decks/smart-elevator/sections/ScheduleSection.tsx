...
const COLOR_MAP: Record<string, { bg: string; border: string; badge: string; text: string }> = {
  ...
  indigo: { bg: "bg-indigo-950/50", border: "border-amber-400/50 dark:border-amber-600/30", badge: "bg-indigo-500/20 text-indigo-200", text: "text-indigo-200" },
};
...
export function ScheduleSection() {
  ...
  return (
    <section id="s-schedule" className={`${SECTION} bg-violet-50 dark:bg-[#1a0f0a] relative`}>
