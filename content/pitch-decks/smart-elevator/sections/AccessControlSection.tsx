        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4">
          {a.steps.map((step: any, i: number) => (
            <div
              ...
              className={`mi-child relative rounded-xl bg-d-bg/60 border border-indigo-400/25 p-4 text-center ${isMobile ? "cursor-pointer active:scale-[0.98] transition-transform" : ""}`}
            >
              {i < a.steps.length - 1 && (
