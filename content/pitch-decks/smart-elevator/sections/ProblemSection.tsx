        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {p.items.map((item: any, i: number) => (
            <div
              ...
              className={`mi-child flex gap-4 rounded-xl bg-stone-900/60 border border-cyan-400/15 p-4 sm:p-5 ${isMobile ? "cursor-pointer active:scale-[0.98] transition-transform" : ""}`}
            >
