...
function PortalIntegrationDeckInner() {
  const c = useContent();
...
interface PortalIntegrationDeckProps {
  access?: DeckAccess;
...
export function PortalIntegrationDeck({
  access = "public",
  previewSlides = DEFAULT_PREVIEW_SLIDES,
  isAuthenticated = false,
  userRole,
}: PortalIntegrationDeckProps) {
  return (
    <DeckThemeProvider>
      <DeckAccessProvider
        access={access}
